                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div className={classes.designer_things}>
                                        <p>
                                            No sugar-coated critiques here. I care about your growth too much to not keep it real. Well tear things down and rebuild them better, together.
                                        </p>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div className={classes.frontend_div2}>
                                        <p>
                                            I dont profess to be at the top of the design talent pool, because I know there is still much for me to master. Design is a moving target Im hunting every day.
                                        </p>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div>
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div className={classes.designer_things}>
                                            <p>
                                                To me, youre more than just a mentee. You’re a designer — an industry peer. I’m not the only one teaching and you’re not the only one learning.
                                            </p>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div>
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div className={classes.frontend_div2}>
                                            <p>
                                                I dont have all the answers, but Im happy to point you towards useful resources and share what Ive learned from my own personal design journey.
                                            </p>
                                        </div>
                                    </li>
                                </ul>
