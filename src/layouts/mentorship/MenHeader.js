    ...
    return (
        <div>
            ...
            <div className={classes.heading}>
                <h3 className={classes.h3}>I havent met you, and this is crazy...</h3>
                <h1 className={classes.h}>But if you need a mentor, then email me maybe.
                </h1>
            </div>
            ...
            <div className={classes.blue_bar}>
                <div className={classes.blue_bar_content}>
                    ...
                    <p>
                        It seems like every other day theres a new design
                        trend to learn, tool to master, and endless design-related
                        articles to read. Honestly, it can be overwhelming
                        and intimidating. I know because Ive walked more
                        than a few miles in those shoes. So whether youre
